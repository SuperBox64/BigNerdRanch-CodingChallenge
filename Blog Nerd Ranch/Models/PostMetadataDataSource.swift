...
struct PostMetadataDataSource {
    ...
    mutating func groupByAuthor(sorting: Sorting) {
        ...
        /// Since we can't guarantee sort with both Set and Dictionaries, we will convert this to an array later and sort it,
        /// This set are the keys of our dictionary which we will cross reference later
        ...
        case .alphabeticalByAuthor(ascending: let ascending):
            ...
            /// Lets keep track of what the last sort by Author was, to be use as a group hierachy stand in
    ...
    /// 3 types of groups times 6 different ways of sorting = 18 possibilities or 9 if we only count our top level grouping switch cases
